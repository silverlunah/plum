...
// Mirrors backend/constants/ai.js.
...
export const ANALYSIS_VERDICT = Object.freeze({
	TEST_CODE: 'test-code',
...
// An investigation runs detached on the server, so the report page polls for it.
