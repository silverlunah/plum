...
- **Frontend**: SvelteKit 5. ESM, no TypeScript. `npm run dev` serves on 3002. In Docker the app is built and served by `@sveltejs/adapter-node` on 3002, which `plum server` publishes as **3002**.
